import { Renderer, Camera, Transform, Plane, Post, Vec2, Vec3 } from 'ogl'
import NormalizeWheel from 'normalize-wheel'

import * as THREE from 'three';
var fragment = require('webpack-glsl-loader!./post.glsl')
...
export default class App {
  ...
  createRenderer () {
    ...
    document.querySelector('.demo-2__gallery').appendChild(this.gl.canvas)
  }
